"""Herramientas internas de revision, control de calidad y clasificacion.

Incluye las interfaces HTML para revisar sellos, bloques de texto,
page-objects y clasificacion, mas la vista de prueba de modelos. No forma
parte de la API publica de OCR: es tooling interno de anotacion/QA.
"""
...
@router.get("/stamps/review", response_class=HTMLResponse)
def stamps_review():
...
@router.post("/page-objects/validate")
...
@router.post("/page-objects/release")
...
@router.get("/text/review", response_class=HTMLResponse)
def text_review():
...
@router.get("/text/review/compare", response_class=HTMLResponse)
...
@router.get("/text/review/skipped", response_class=HTMLResponse)
...
@router.get("/text/review/qc", response_class=HTMLResponse)
def text_review_qc():
    review_version = os.getenv("TEXT_REVIEW_APP_VERSION", os.getenv("REVIEW_APP_VERSION", "0"))
    html = """
<!doctype html>
...
@router.get("/text/review/audit/round-stamps", response_class=HTMLResponse)
...
@router.get("/text/review/compare/labels")
...
@router.get("/models/test", response_class=HTMLResponse)
...
@router.get("/models/test/pdfs")
def models_test_pdfs():
    return {"items": _list_model_test_pdfs()}


@router.get("/models/test/pdf-info")
...
@router.get("/models/test/page.png")
...
@router.get("/stamps/review/items")
...
@router.get("/text/review/skipped/next")
...
@router.get("/text/review/history")
...
@router.get("/text/review/qc/stats")
def text_review_qc_stats():
    return _text_review_qc_stats_payload()


@router.post("/stamps/review/validate")
...
@router.post("/text/review/validate")
...
@router.post("/stamps/review/release")
...
@router.post("/text/review/release")
...
@router.post("/text/review/requeue")
...
@router.get("/text/review/qc/item-status")
...
@router.post("/text/review/qc/mark")
...
@router.get("/stamps/review/labels")
...
@router.get("/text/review/qc/labels")
...
@router.get("/text/review/audit/round-stamps/labels")
...
@router.post("/stamps/review/labels")
...
@router.post("/text/review/labels")
...
@router.post("/text/review/qc/labels")
